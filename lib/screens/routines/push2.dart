...
class Push2 extends StatefulWidget {
  ...
  @override
  State<Push2> createState() => _Push2State();
}

class _Push2State extends State<Push2> {
  final _controller = YoutubePlayerController(
    initialVideoId: 'FWDXsqHo14A',
                    ...
                    child: Table(
                      ...
                      children: const [
                        ...
                        TableRow(
                          ...
                          children: [
                            ExerciseEntry('Incline Bench Press'),
                            ExerciseEntry('3-4'),
                            ExerciseEntry('6-8'),
                            ExerciseEntry('2-3'),
                          ],
                        ...
                        TableRow(
                          ...
                          children: [
                            ExerciseEntry('Standing Dumbbell Shoulder Press'),
                            ExerciseEntry('3-4'),
                            ExerciseEntry('10-15'),
                            ExerciseEntry('2-3'),
                          ],
                        ...
                        TableRow(
                          ...
                          children: [
                            ExerciseEntry('Paused Flat Dumbbell Press'),
                            ExerciseEntry('3-4'),
                            ExerciseEntry('8-12'),
                            ExerciseEntry('2-3'),
                          ],
                        ...
                        TableRow(
                          ...
                          children: [
                            ExerciseEntry('Lean-Away Dumbbell Lateral Raise'),
                            ExerciseEntry('2-3 per arm'),
                            ExerciseEntry('10-15'),
                            ExerciseEntry('1 between arms'),
                          ],
                        ),
                        TableRow(
                          decoration: BoxDecoration(
