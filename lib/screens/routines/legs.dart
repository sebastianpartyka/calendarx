                    ...
                    child: Table(
                      ...
                      children: const [
                        ...
                        TableRow(
                          ...
                          children: [
                            ExerciseEntry('Walking Barbell Lunges'),
                            ExerciseEntry('3-4'),
                            ExerciseEntry('15-20'),
                            ExerciseEntry('2-3'),
                          ],
                        ...
                        TableRow(
                          ...
                          children: [
                            ExerciseEntry('Seated Leg Curls'),
                            ExerciseEntry('2-4'),
                            ExerciseEntry('10-15'),
                            ExerciseEntry('2-3'),
                          ],
                        ...
                        TableRow(
                          ...
                          children: [
                            ExerciseEntry('Seated OR Standing Calf raises'),
                            ExerciseEntry('2-3'),
                            ExerciseEntry('15-20'),
                            ExerciseEntry('1.5-2'),
                          ],
